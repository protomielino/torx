...
extern ANN* LoadANN_fname(char* filename);
extern ANN* LoadANN_fdesc(FILE* f);
extern int SaveANN_fname(ANN* ann, char* filename);
extern int SaveANN_fdesc(ANN* ann, FILE* f);
...
extern void ANN_FreeLayer_low_level (void* l);
