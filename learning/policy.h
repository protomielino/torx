...
typedef struct DiscretePolicy_
{
//protected:
...
//protected:
int DiscretePolicy_confMax(DiscretePolicy *this, real* Qs, real* vQs, real p/* = 1.0*/); ///< Confidence-based Gibbs sampling
int DiscretePolicy_confSample(DiscretePolicy *this, real* Qs, real* vQs); ///< Directly sample from action value distribution
int DiscretePolicy_softMax(DiscretePolicy *this, real* Qs); ///< Softmax Gibbs sampling
int DiscretePolicy_eGreedy(DiscretePolicy *this, real* Qs); ///< e-greedy sampling
